...
class TimePerCollect(SDMXAttribute):
    def __init__(self):
        ...
        # self.data = {
        #     "id": "urn:ngsi-ld:AttributeProperty:timePerCollect",
        ...
        #         "type": "Property",
        #         "value": {
        #             "en": "Dates or periods during which the observations have been collected "
        #                   "(such as middle, average or end of period) to compile the indicator "
        #                   "for the target reference period.",
        #         }
        #     },
        #     "concept": {
        #         "type": "Relationship",
        #         "object": "urn:ngsi-ld:Concept:timePerCollect"
        #     },
        #     "dct:identifier": {
        #         "type": "Property",
        #         "value": "timePerCollect"
        #     },
        #     "rdfs:range": {
        #         "type": "Property",
        #         "value": "xsd:string"
